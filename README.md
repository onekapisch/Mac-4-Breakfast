...
> [!NOTE]
> **Mac 4 Breakfast is a commercial, closed-source app.** This repository hosts its **documentation, changelog, and issue tracker**, not the source code. Bug reports and feature requests are very welcome, so please [open an issue](https://github.com/onekapisch/Mac-4-Breakfast/issues/new/choose).
...
Not as a hardware cap, which needs a privileged background helper we deliberately don't ship. Instead it gives you an **unplug reminder** when you reach your target.
